...
[architecture](docs/agent/architecture.md), [agent loop](docs/agent/agent-loop.md),
[tools](docs/agent/tools.md), [memory](docs/agent/memory.md),
[security](docs/agent/security.md), [configuration](docs/agent/configuration.md),
[development](docs/agent/development.md), [API](docs/agent/api.md), and
[examples](docs/agent/examples.md). An architecture/integration analysis is in
[docs/agent/analysis.md](docs/agent/analysis.md).
